...
class UNetModel_assist(nn.Module):
    """
...
class SuperResModel_assist(UNetModel_assist):
    """
    ...
    def forward(self, x, timesteps, cond, low_res=None, **kwargs):
        _, _, new_height, new_width = x.shape
        upsampled = F.interpolate(low_res, (new_height, new_width), mode="bilinear")
        x = th.cat([x, upsampled], dim=1)
        return super().forward(x, timesteps, y=cond, **kwargs)


class EncoderUNetModel_assist(nn.Module):
    """
