...
layout_save_root = "/home/Users/dqy/Dataset/Cityscapes/layout_prior_eliminate/"
...
for level in range(1, 20):
    layout_save_folder_level = os.path.join(layout_save_root, f"L{level}")
    for phase in ["train", "val"]:
        layout_save_folder = os.path.join(layout_save_folder_level, phase)
        ...
        for file in tqdm.tqdm(files):
            ...
            for semantic in semantic_priority[::-1][level:]:  # 先填充低优先级的区域，这样会保证后填充的高优先级区域将低优先级区域覆盖
